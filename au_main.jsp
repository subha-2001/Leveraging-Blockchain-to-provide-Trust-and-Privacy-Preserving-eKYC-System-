    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  <p><img src="images/gal4.jpg" width="521" height="228" /></p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li class="style4"><a href="au_all_owners.jsp">View All Clients and Authorize</a></li>
            <li><strong><a href="au_all_users.jsp">View All Smart contracts Users and Authorize</a></strong></li>
