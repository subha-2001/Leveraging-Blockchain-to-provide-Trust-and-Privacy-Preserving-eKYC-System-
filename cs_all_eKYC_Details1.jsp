...
<title>View_All_eKYC_Details</title><body>
  ...
  <tr>
	...
	<td width="98" bgcolor="#FF0000"><div align="center" class="style6 style3 style4 style2"><strong> Permission Status </strong></div></td>
	...
	<%
		...
		try {
			...
			String query = "select * from ekyc_details where permit='"+str+"' ";
	...
	<%
		...
		<h2>No eKYC Details are Permitted from Smart contracts</h2>
		<%}
